...
//! the shader code.
//!
//! Where possible, we reuse shader imports from [`bevy::pbr`] to implement
//! lighting effects. Sadly there are still some shader functions and code
//! blocks that are copy-pasted from Bevy; we are hoping to eliminate these in
//! the future to make this crate easier to maintain.
//!
